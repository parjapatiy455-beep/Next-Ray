...
export const AVAILABLE_MODELS: AIModel[] = [
  ...
  },
  {
    ...
    name: "Gemma 2 2B",
    provider: "NVIDIA",
    description: "Google's lightweight model. Fast, highly optimized for standard tasks, reasoning, and instruction-following.",
    badge: "Compact & Swift",
    maxTokens: 4096,
    isVision: false,
  },
  {
    ...
    name: "Kimi K2.6",
    provider: "NVIDIA",
    description: "Moonshot AI's conversational model, engineered for highly coherent dialogue and long-context processing.",
  ...
  },
  {
    ...
    name: "Qwen 3.5 397B",
    provider: "NVIDIA",
    description: "Alibaba's mammoth 397B model representing extreme scale and logical reasoning capacity.",
    badge: "Mammoth Scale",
    maxTokens: 16384,
    isVision: false,
  },
